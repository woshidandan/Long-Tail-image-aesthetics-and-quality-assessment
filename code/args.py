...
def init():
    ...
    # path
    parser.add_argument('--csv_path', type=str, default="/home/llm/codebase/LTIAA/dataset/AVA/",
                        help='path to dataset-label csv file')
    parser.add_argument('--dataset_path', type=str, default='/mnt/disk2/fast_dataset/shuai/avadata/images',
                        help='path to dataset')
    parser.add_argument('--test_dataset_path', type=str, default='/mnt/disk2/fast_dataset/shuai/avadata/images',
    ...
    parser.add_argument('--mixup', default=False, action='store_true', help='whether to enable mixup')
